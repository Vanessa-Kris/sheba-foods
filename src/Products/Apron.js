            ...
            <Box sx={{ mt: 5 }}>
              <Grid container columnSpacing={2}>
                ...
                <Grid item md={6} sm={6} xs={8} sx={{ color: "#505050" }}>
                  <Typography> Sheba Meals Apron </Typography>
        ...
        <Grid container columnSpacing={8} rowSpacing={4} sx={{ mt: 2 }}>
          ...
          {/* <Grid item md={4} sm={4} xs={6} component="a" href="/products/apron">
            <Box
              ...
              sx={{ width: "100%" }}
            />
            <Typography variant="p" sx={{ fontWeight: 500 }}>Sheba Meals Apron</Typography>
            <Typography variant="body2" sx={{ fontWeight: 300 }}>
              NGN 2000
            </Typography>
          </Grid> */}
